...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center p-4'>
        <form method='post' action="https://getform.io/f/f2db8fd5-c089-4988-a29c-9419ad5bdf16" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300'>Contact Me!</p>
                <p className='text-gray-300 py-4'>Submit the form below or send me an email - rlauriant@gmail.com</p>
            </div>
            ...
            <textarea name="message" rows="10" className='bg-[#ccd6f6] p-2'></textarea>
